...
public class CryptoHub extends Application {
    private static CryptoHub application;

    // Generate all the pairs
    private static ArrayList<TradingPair> pairs = new ArrayList<TradingPair>();;
    ...
    private void initialize() {
        // Add default pairs
        pairs.add( new TradingPair("BTC/CNY", "OkCoin") );
        pairs.add( new TradingPair("BTC/USD", "Bitfinex") );
        pairs.add( new TradingPair("BTC/USD", "Bitstamp") );
        pairs.add( new TradingPair("BTC/EUR", "Kraken") );
        pairs.add( new TradingPair("BTC/USD", "Btc-e") );
        pairs.add( new TradingPair("ETH/BTC", "Poloniex") );
        pairs.add( new TradingPair("ETH/BTC", "HitBTC") );
    }

    public static ArrayList<TradingPair> getPairs() {
        return pairs;
    }
